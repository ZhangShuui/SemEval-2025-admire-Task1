...
model_path = "./share_models/Qwen2.5-VL-32B-Instruct"  # after RL
ori_processor_path = "./share_models/Qwen2.5-VL-32B-Instruct"
...
def run(rank, world_size):
    ...
    for image in tqdm(train_split):
        ...
        question = (
            ...
            f"You should only output the list of image indexes in the expected order, without any other text.\n"
            f"Now, your output:"
        )
        query = question
        ...
        messages = [
            {
                ...
                "content": [
                    {"type": "image", "image": base_dir + image_path_1},
                    {"type": "image", "image": base_dir + image_path_2},
                    {"type": "image", "image": base_dir + image_path_3},
                    {"type": "image", "image": base_dir + image_path_4},
                    {"type": "image", "image": base_dir + image_path_5},
                    {"type": "text", "text": query},
                ],
            }
        ]
