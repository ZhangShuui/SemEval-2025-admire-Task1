...
model_path = "/home/szhangfa/Visual-RFT/share_models/Qwen2-VL-2B-Instruct_GPRO_aircraft_4_shot"  # after RL
model_base = (
    "/home/szhangfa/Visual-RFT/share_models/Qwen2-VL-2B-Instruct"  # original Qwen2-VL
)
...
def run(rank, world_size):
    ...
    for image in tqdm(split_images):
        ...
        image_path = image_path.replace(
            "/mnt/petrelfs/liuziyu/LLM_Memory/SimplyRetrieve/CLIP-Cls/data/fgvc_aircraft/images/",
            "/home/szhangfa/Visual-RFT/data/fgvc-aircraft-2013b/data/images/",
        )
        query = question
